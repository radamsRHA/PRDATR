#' Function_ComputePairwiseDistances_SimulateTips_PDA: function to generate pairwise distance computations
#'
...
##############################################################
# Function_ComputePairwiseDistances_SimulateTips_PDA #
##############################################################
Function_ComputePairwiseDistances_SimulateTips_PDA <- function(numeric.NumberReps, numeric.n, string.Model, vector.Theta){
  ...
  for (t in 1:numeric.NumberReps){
    ...
    handle.Tree <- as.phylo.treeshape(x = rpda(tip.number = numeric.n))
